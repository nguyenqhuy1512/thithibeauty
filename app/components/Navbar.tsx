    ...
    return (
        <>
            <nav className="bg-transparent">
                <div ref={stickyElementRef} className={`h-auto w-full top-0 ${scrollY > 20 ? `fixed transition ease-in-out duration-700 bg-white` : `absolute`}`}>
                    <div className="mx-auto px-10 py-2 flex justify-between items-center hover:bg-white transition ease-in-out duration-700">
                        ...
                        <div className="hidden md:flex space-x-6 lg:space-x-14">
                            ...
                            <div className="relative content-center" onMouseEnter={toggleServicesDropdown}> {/* onMouseLeave={toggleFeaturesDropdown} */}
                                ...
                                <ul onMouseEnter={toggleServicesDropdown} onMouseLeave={closeServicesDropdown} className={`absolute ${showServicesDropdown ? 'block' : 'hidden'} bg-white shadow rounded-md mt-2 w-36`}>
                            ...
                            <div className="relative content-center" onMouseEnter={toggleProductsDropdown} > {/* onMouseLeave={toggleFeaturesDropdown} */}
                                ...
                                <ul onMouseEnter={toggleProductsDropdown} onMouseLeave={closeProductsDropdown} className={`absolute ${showProductsDropdown ? 'block' : 'hidden'} bg-white shadow rounded-md mt-2 w-48`}>
