        ...
        <>
            ...
            <div className='relative mt-10 w-full h-[100px] items-center justify-center'>
                <ul className='flex h-full w-full items-center justify-center space-x-2'>
                    {props.map((item) => (
                        <li key={item.id} className={`${item.id === tabSelectId && `bg-pink-50`} grid text-center content-center place-items-center w-full h-auto p-2 hover:underline hover:text-pink-400 hover:bg-pink-50`}>
                            ...
                            <span onClick={() => { setTabSelectId(item.id) }}
                                className={`border-none bg-transparent text-lg hover:underline hover:text-pink-400 cursor-pointer 
                    ...
                    <div className='flex-grow w-1/2 h-[500px] p-5 place-content-center'>
                        ...
                        <div className='flex justify-center space-x-5 mt-5'>
                            <div className='flex justify-center group '>
                                <button className="btn hover:bg-pink-600 group-hover:text-white hover:font-bold ">
                                    ĐẶT LỊCH
                            ...
                            <div className='flex justify-center group'>
                                <button className='btn w-full group-hover:text-white hover:bg-gray-500 hover:outline-none hover:font-bold'>
                                    XEM CHI TIẾT
